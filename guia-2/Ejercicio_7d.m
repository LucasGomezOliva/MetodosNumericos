...
t0 = 0;   % Tiempo Inicial
tF = 2;   % Tiempo Final
y0 = 1/10;   % Condición inicial
e=2.71
% Análisis con 20 pasos de Iteración
M1 = 20;  % Pasos de solución
%h1 = (tF-t0)/M1; % At

E1 = Ec_Dif_Heun('Ec_Dif_2d',t0,tF,y0,M1);

t = E1(:,1);    % vector de tiempo
ya1 = E1(:,2);  % Solución aproximada de la Ec. Dif.
y_v = (1/10)*e.^(-2*t)+t.*e.^(-2*t); % Solución verdadera de la Ecuación Diferencial
figure(1);
...
E2 = Ec_Dif_Heun('Ec_Dif_2d',t0,tF,y0,M2);
