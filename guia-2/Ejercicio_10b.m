...
E1 = Ec_Dif_Runge_Kutta_O4('Ec_Dif_2b',t0,tF,y0,M1);

t = E1(:,1);    % vector de tiempo
ya1 = E1(:,2);  % Solución aproximada de la Ec. Dif.
y_v = 4/3*exp(3*t)-t-1/3; % Solución verdadera de la Ecuación Diferencial
figure(1);
...
E2 = Ec_Dif_Runge_Kutta_O4('Ec_Dif_2b',t0,tF,y0,M2);
